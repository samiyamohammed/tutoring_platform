...
import {
  Primitive
} from "./chunk-7HIAUKFX.js";
import {
  useComposedRefs
} from "./chunk-LOTXHNRN.js";
import {
  require_jsx_runtime
...
var Checkbox = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(CheckboxProvider, { scope: __scopeCheckbox, state: checked, disabled, children: [
...
var CheckboxIndicator = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || isIndeterminate(context.state) || context.state === true, children: (0, import_jsx_runtime2.jsx)(
      Primitive.span,
      {
