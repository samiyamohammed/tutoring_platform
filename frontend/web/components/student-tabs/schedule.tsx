...
export function getUpcomingSessions(enrollments: any[]): Session[] {
  ...
  enrollments.forEach((enrollment) => {
    const sessionType = enrollment.enrolledSessionType as
      | "online"
      | "group"
      | "oneOnOne";
    const courseSchedule =
      enrollment.course.pricing[sessionType]?.schedule || [];
                ...
                <div className="space-y-2">
                  {daySessions.map((session) => (
                    <div
                      ...
                      className="p-2 text-xs border rounded hover:bg-muted/50 cursor-pointer"
                    >
