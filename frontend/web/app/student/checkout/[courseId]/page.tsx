                  ...
                  <CardContent className="space-y-6">
                        ...
                        >
                          {isSessionTypeAvailable("online") && (
                            <TabsTrigger value="online">
                              ...
                              <span className="ml-1 text-xs">
                                ETB {course.pricing.online?.price}
                              </span>
                            </TabsTrigger>
                          )}
                          {isSessionTypeAvailable("group") && (
                            <TabsTrigger value="group">
                              Group Sessions
                              <span className="ml-1 text-xs">
                                ETB {course.pricing.group?.price}
                              </span>
                            </TabsTrigger>
                          )}
                          {isSessionTypeAvailable("oneOnOne") && (
                            <TabsTrigger value="oneOnOne">
                              1-on-1 Sessions
                              <span className="ml-1 text-xs">
                                ETB {course.pricing.oneOnOne?.price}
                              </span>
                            </TabsTrigger>
                          )}
                        </TabsList>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div className="flex items-center space-x-2 border rounded-md p-4">
                          ...
                          <div className="font-medium">ETB {basePrice}</div>
                        </div>
                        <div className="flex items-center space-x-2 border rounded-md p-4">
                          <RadioGroupItem
                            value="installment"
                    ...
                    {paymentOption === "installment" && (
                      <Alert>
                        ...
                        <AlertDescription>
                          You'll be charged ETB {installmentPrice} today, and
                          the same amount on the same day for the next 2 months.
                        </AlertDescription>
                      </Alert>
                    )}
                  </CardContent>
              ...
              <div>
                <Card className="sticky top-6">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {paymentOption === "installment" && (
                      <div className="flex justify-between">
                        ...
                        <span>ETB {installmentPrice}</span>
                      </div>
                    )}
                    <Separator />
                  ...
                  <CardFooter className="flex flex-col space-y-4">
                    <div
                      onClick={() =>
                        localStorage.setItem("lastPaidCourseId", course._id)
                      }
                    >
                      <DirectChapaButton
                        amount={totalPrice}
