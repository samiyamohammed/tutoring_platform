...
export default function DocumentVerificationPage() {
  ...
  const handleFileUpload = (
    ...
    if (invalidFiles.length === 0) {
      const currentFiles =
        form.getValues(`documents.${documentIndex}.files`) || [];
      ...
      form.setValue(`documents.${documentIndex}.files`, [
        ...currentFiles,
        ...newFiles,
      ]);
    }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Submit your documents to become a verified tutor
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-4xl space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Complete your tutor profile by submitting verification
                  documents. This helps us ensure quality education on our
                  platform.
                </p>
              </div>
              ...
              {tutorData?.verification_documents &&
                tutorData.verification_documents.length > 0 && (
                  <Card>
                    <CardHeader>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {tutorData.verification_documents.map(
                          (docGroup, groupIndex) => (
                      ...
                      {fields.map((field, index) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {form.watch(`documents.${index}.type`) ===
                              "other" && (
                              <FormField
                                control={form.control}
                          ...
                          {form.watch(`documents.${index}.files`)?.length >
                            0 && (
                            <div className="mt-4">
